...
var autopilot_tested = 0;
var test_in_progress = 0;
var test_failed = 1;

var nav_armed=0;
var apr_armed=0;
var gs_armed=0;
var alt_armed=0; alt_alert_disp_timeout=0;
var vs_armed=0;
var cws_btn_pressed=0;
var ann_mode_ap = 0;
var ann_mode_trim = 0;


var trim_dn_btn_pressed=0;
var trim_up_btn_pressed=0;
var cws_trim_dn_btn_pressed=0;
var cws_trim_up_btn_pressed=0;
var ap_flash_time=0;
var yd_flash_time=0;
...
inc_value_fine= func {
  if (getprop("/instrumentation/autopilot/as-vs-sw")==1) {
    ...
    var alt = getprop("/instrumentation/autopilot/selected-alt");
    if (alt+100 > 50000) {
        alt=49900;
    }
