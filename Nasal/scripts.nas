...
Propeller_noise = func {
  ...
  var a = math.atan2 (getprop("/instrumentation/airspeed-indicator/indicated-speed-kt"), 30 * getprop("/engines/engine[0]/thruster/rpm") / 60) * 57;
  var da = getprop("/engines/engine[0]/thruster/pitch") - a;
  if (da<0) { da = -da * 5; }
  ...
  a = math.atan2 (getprop("/instrumentation/airspeed-indicator/indicated-speed-kt"), 30 * getprop("/engines/engine[1]/thruster/rpm") / 60) * 57;
